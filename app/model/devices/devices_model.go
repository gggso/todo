...
// arModel is a active record design model for table devices operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of devices.
	Table = "devices"
	// Model is the model object of devices.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table devices.
	Columns = struct {
		Id          string // id                                                
        Type        string // 设备类型 1: 手机                                  
        Model       string // 型号 getprop ro.product.model                     
        Size        string // 分辨率 dumpsys window | grep mUnrestrictedScreen  
        AndroidId   string // android_id settings get secure android_id         
        Version     string // 系统版本 getprop ro.build.version.release         
        Sdk         string // sdk getprop ro.build.version.sdk                  
        Brand       string // 厂商名称 getprop ro.product.brand                 
        DevicesId   string // 设备id getprop ro.serialno                        
        Imei        string // IMEI service call iphonesubinfo 1  需要自己处理   
        Mac         string // MAC cat /sys/class/net/wlan0/address              
        Df          string // 内存 df /data 自己处理                            
        CreateTime  string // 创建时间                                          
        LastTime    string // 上次在线时间                                      
        Group       string // 分组                                              
        Status      string // 设备状态 0 正常 1 禁用                            
        Uuid        string // 设备唯一id
	}{
		Id:         "id",           
        Type:       "type",         
